...
<script src="https://cdn.jsdelivr.net/gh/S-o-c-i-a-l-m-a-r-k/competition-configuration@v1.1.2/widget.js"></script>
...
- **Manual Groups Override**: Set exact group counts for any round (new in v1.1.2)
